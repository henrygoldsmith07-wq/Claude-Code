  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'Focus Timer',
          icon: '⏲️',
          tagline: 'Pomodoro blocks; only completed ones count.',
          status: 'live',
        },
        {
          slug: 'grades',
          name: 'Grade Tracker',
          icon: '📊',
          tagline: 'Mock and test marks per subject, trend visible.',
          status: 'live',
        },
        {
          slug: 'quick-cards',
          name: 'Quick Cards',
          icon: '🃏',
          tagline: 'Scrappy flashcards for today’s facts.',
          status: 'live',
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'Idea Vault',
          icon: '💡',
          tagline: 'Score impact vs effort, promote winners to the pipeline.',
          status: 'live',
        },
        {
          ...
          icon: '🧾',
          tagline: 'The same eight shipping steps for every app.',
          status: 'live',
        },
        {
          slug: 'knowledge-base',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'Meal Log',
          icon: '🍽️',
          tagline: 'One line per meal — awareness over calorie maths.',
          status: 'live',
        },
        {
          slug: 'screen-time',
          name: 'Screen Time',
          icon: '📵',
          tagline: 'Doomscroll hours vs a daily ceiling.',
          status: 'live',
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'Wishlist',
          icon: '🎁',
          tagline: 'Park the impulse; a week later it earns its price.',
          status: 'live',
        },
      ],
    },
