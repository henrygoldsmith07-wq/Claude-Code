...
import {
  Bell, ChartNoAxesColumn, PiggyBank, Plus, Trash2, TrendingUp,
} from 'lucide-react';
import { useApp } from '../lib/store.jsx';
import { spendByMonth, weekDates } from '../lib/kitchen.js';
import { planStats } from '../lib/mealplan.js';
import { gbp } from '../lib/utils.js';
import { Bars, Card, Meter, Pill, Section } from './ui.jsx';
...
export default function BudgetPanel() {
  ...
  return (
    <div className="pb-6 space-y-5">
      ...
      <Section className="rise rise-2" title="Price-drop alerts">
        <Card className="space-y-3">
