...
function LogWorkout() {
  ...
  return (
    <Card className="space-y-3">
      <p className="text-[12px] font-bold uppercase tracking-wide" style={{ color: 'var(--faint)' }}>What did you do?</p>
      ...
      <div className="rounded-2xl p-3" style={{ background: 'var(--card-2)' }}>
        {estimate ? (
          <>
            <p className="text-[16px] font-extrabold">≈ {estimate} kcal</p>
            <p className="text-[12px] font-semibold" style={{ color: 'var(--muted)' }}>
...
function ImportWorkouts() {
  ...
  return (
    <Card className="space-y-3">
      <p className="text-[12px] font-bold uppercase tracking-wide" style={{ color: 'var(--faint)' }}>From your health app</p>
      <p className="text-[12.5px] font-semibold" style={{ color: 'var(--muted)' }}>
      ...
      {HEALTH_SOURCES.map((s) => (
        <div key={s.id}>
          ...
          <p className="text-[12px] font-semibold" style={{ color: 'var(--muted)' }}>{s.how}</p>
        </div>
      ))}
      <textarea
        value={text}
...
export default function ExercisePanel() {
  ...
  return (
    <div className="px-5 pb-10 space-y-4">
      <Card>
        <p className="text-[12px] font-bold uppercase tracking-wide" style={{ color: 'var(--faint)' }}>This week</p>
        {week.sessions === 0 ? (
      ...
      <Card>
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <p className="font-bold text-[14px]">Count exercise calories</p>
            <p className="text-[12px] font-semibold" style={{ color: 'var(--muted)' }}>
        ...
        <div className="mt-3 rounded-2xl p-3" style={{ background: 'var(--card-2)' }}>
          ...
          <p className="mt-0.5 text-[12px] font-semibold inline-flex items-start gap-1.5" style={{ color: 'var(--muted)' }}>
