...
export const CAPABILITIES = [
  ...
  cap('retailers', 'UK retailer integration', 'partial',
    'Tesco, Sainsbury’s, Asda, Aldi, Lidl, Morrisons, Waitrose, Ocado and Amazon Fresh each have official product, offers and fulfilment links. Recorded receipt prices and saved vouchers stay local. A server-side adapter can use a licensed feed for any listed retailer; barcode enrichment can use Open Food Facts and community price observations can use Open Prices. No undocumented supermarket endpoint is assumed, and observed prices are never presented as live quotes.'),
