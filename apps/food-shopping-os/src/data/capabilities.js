...
export const CAPABILITIES = [
  ...
  cap('receipt', 'Receipt scanner', 'partial',
    'Same again: paste the receipt text from your retailer’s app or email, and it parses items, prices, quantities, store and date — then checks its own arithmetic against the printed total and tells you if it doesn’t match.'),
  ...
  cap('api', 'API integrations', 'impossible',
    'An API needs a server to hold credentials and take requests. Forq has neither, by design — that is the same decision that means nobody can read your diary.',
    'The exports are the integration surface, and they are all open formats: CSV for the diary, foods and measurements; .ics for reminders; JSON for everything; share codes for recipes.'),
