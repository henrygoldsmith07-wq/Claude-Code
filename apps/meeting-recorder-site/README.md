# meeting-recorder — intro site

Static landing page for `meeting-recorder`.

Same contract as `apps/le-studio-site`:

- One `index.html` + icons — no build step.
- Vercel project **Root Directory: `apps/meeting-recorder-site`**, Framework Preset **Other**, no build command, output directory `.`.
