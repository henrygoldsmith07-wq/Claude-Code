# world-news — intro site

Static landing page for `world-news`.

Same contract as `apps/le-studio-site`:

- One `index.html` + icons — no build step.
- Vercel project **Root Directory: `apps/world-news-site`**, Framework Preset **Other**, no build command, output directory `.`.
