...
function synthCorpus(){
  ...
  const entries=[
    ...
    ['gha-fail.log', d.githubActionsLog({jobs:3, stepsPerJob:8})],
    ['diff-4files.log', d.diffLog({files:4})],
    ['stack.log', d.stackLog()],
    ['json-search.log', d.jsonSearchResults({hits:50})],
    ...
    // Real CI failure shapes (roadmap: logs from real CI failures)
    ['npm-ci-fail.log', d.npmCiFailLog()],
    ['cargo-build-fail.log', d.cargoBuildFailLog()],
    ['playwright-fail.log', d.playwrightFailLog()],
    ['eslint-scan.log', d.eslintScanLog()],
    ['gha-real-fail.log', d.ghaRealFailLog()],
    ['pytest-traceback.log', d.pytestTracebackLog()],
  ];
