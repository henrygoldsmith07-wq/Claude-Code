...
import { emptyGraph, validateGraph, claimSupportMap } from "./argGraph";
...
function sample(): ArgGraph {
  return {
    nodes: [
      ...
      { id: "e1", kind: "evidence", owner: "a", text: "Lazard LCOE 2024: solar $24/MWh.", round: 1, evidenceStrength: "cited" },
