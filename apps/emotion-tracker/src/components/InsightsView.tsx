      ...
      {completed.length === 0 ? (
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            {/* Bars are decorative for screen readers — the sr-only summary
                below carries the actual counts. */}
            ...
            <p className="sr-only">
              Reflections over the last 14 days:{" "}
              {dayCounts.map((d) => `${d.label} ${d.count}`).join(", ")}.
            </p>
          </div>
